 ...
 * {@code data/syalchemy/enchantment/*.json}; their <i>gameplay</i> is applied here in code because a
 * "spell power" concept is a mod invention with no vanilla effect component. The JSONs only carry
 * the metadata (name, cost, {@code supported_items = #syalchemy:enchantable/staff}) so the enchanted
 ...
 * offered at an enchanting table — a {@link com.syang.syalchemy.world.item.StaffItem} is a plain
...
public final class ModEnchantments {
    ...
    public static final TagKey<Item> STAFF_ENCHANTABLE =
            ItemTags.create(Identifier.fromNamespaceAndPath(SyAlchemy.MOD_ID, "enchantable/staff"));
    ...
    private static ResourceKey<Enchantment> key(String path) {
        return ResourceKey.create(Registries.ENCHANTMENT, Identifier.fromNamespaceAndPath(SyAlchemy.MOD_ID, path));
    }
