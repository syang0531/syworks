...
public enum ModAlloy {
    ...
    ModAlloy(String id, String displayName, int uses, float speed, float attackDamageBonus,
        ...
        this.repairTag = ItemTags.create(Identifier.fromNamespaceAndPath(SyAlchemy.MOD_ID, "tool_materials/" + id));
    ...
    /** {@code #syalchemy:tool_materials/<alloy>} — the items that repair this alloy's equipment (its ingot). */
