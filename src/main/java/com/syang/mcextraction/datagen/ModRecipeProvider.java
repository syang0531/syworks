...
public class ModRecipeProvider extends RecipeProvider {
    ...
    private void wand(RecipeOutput recipeOutput, ModWand wand) {
        ...
        builder.save(recipeOutput, ResourceLocation.fromNamespaceAndPath(MCExtraction.MOD_ID, wand.id()));
    }
    ...
    private void equip(RecipeOutput recipeOutput, ItemLike ingot, ItemLike result, String id,
        ...
        builder.save(recipeOutput, ResourceLocation.fromNamespaceAndPath(MCExtraction.MOD_ID, id));
    }
}
