 ...
 * assets/mcextraction/textures/models/armor/&lt;alloy&gt;_layer_1.png (and _layer_2 for leggings).
 */
public final class ModArmorMaterials {

    public static final DeferredRegister<ArmorMaterial> ARMOR_MATERIALS =
            DeferredRegister.create(Registries.ARMOR_MATERIAL, MCExtraction.MOD_ID);
    ...
    private static ArmorMaterial createMaterial(ModAlloy alloy) {
        ...
        return new ArmorMaterial(
                ...
                List.of(new ArmorMaterial.Layer(
                        ResourceLocation.fromNamespaceAndPath(MCExtraction.MOD_ID, alloy.id()))),
                preset.toughness(),
