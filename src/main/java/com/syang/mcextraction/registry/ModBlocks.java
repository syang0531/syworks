...
import com.syang.mcextraction.world.level.block.RuneAltarBlock;
...
public final class ModBlocks {
    ...
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(MCExtraction.MOD_ID);
