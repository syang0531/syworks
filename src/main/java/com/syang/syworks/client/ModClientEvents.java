...
import com.syang.syworks.client.gui.screens.IncineratorScreen;
...
/** Client-only mod-bus events: binds every machine's menu to the shared screen, and the incinerator to its own. */
...
public final class ModClientEvents {
    ...
    public static void onRegisterMenuScreens(RegisterMenuScreensEvent event) {
        ...
        event.register(ModMenuTypes.INCINERATOR.get(), IncineratorScreen::new);
    }
}
