 ...
 * ({@code assets/yame/items/*.json}, required since 1.21.4) for every block and item.
 *
 * <ul>
 ...
 *       Textures: assets/yame/textures/block/&lt;name&gt;_{side,top,front,front_on}.png.</li>
 *   <li>The Rune Altar model is hand-written (16×12×16 element, enchanting-table shape) at
 *       assets/yame/models/block/rune_altar.json; only its blockstate is generated here.</li>
