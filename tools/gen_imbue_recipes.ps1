# Generates every Rune Altar (mcextraction:imbuing) recipe into
#   src/main/resources/data/mcextraction/recipe/
#
...
$recipeDir = Resolve-Path (Join-Path $PSScriptRoot '..\src\main\resources\data\mcextraction\recipe')
